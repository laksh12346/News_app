    ...
    body = (
      <div className={classes.paper}>
        ...
        <div className={classes.infoContainer}>
          <Typography variant="h5">Search by Categories</Typography>
        ...
        <Divider />
        <div className={classes.infoContainer}>
          <Typography variant="h5">Search by Terms</Typography>
          <div className={classes.chipContainer}>
        ...
        <Divider />
        <div className={classes.infoContainer}>
          <Typography variant="h5">Search by Sources</Typography>
          <div className={classes.chipContainer}>
            {[
              "CNN",
              "Wired",
